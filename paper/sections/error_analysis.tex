...
\begin{itemize}
  ...
  \item \textbf{E2 -- Entailment under-call.} A genuinely-SUPPORTS pair is
    ...
    \texttt{S02}). This is a model-calibration limitation, not a resolver
  ...
  \item \textbf{E6 -- Rhetorical stance conflict misread as neutral.}
    ...
    which an SNLI/MultiNLI/ANLI-calibrated model is not trained to read as
    contradiction. Unlike E4, this is not an integration bug: the resolver
    is faithfully reporting the model's own dominant class. It requires
    either a differently-calibrated (or stance-detection-specific) model,
    not a resolver change, and is recorded as unresolved in
    \S\ref{sec:limitations}.
\end{itemize}

E1--E3 and E6 remain open (E1 is a retrieval-stage problem, E2/E3 are
SUPPORTS-side calibration problems, E6 is an NLI-model calibration gap on
rhetorical rather than propositional disagreement); E4--E5 are the two
