...
SMRITI-Reference markdown files, produced 690 claims --- now
...
690). This is the assertion classifier working as intended: SMRITI now
recovers substantially \emph{less} volume than the naive baseline because
it explicitly discards non-declarative sentence types the naive baseline
cannot distinguish (\S\ref{sec:results-annotation} quantifies the
resulting gain in structural validity directly).

\subsection{Precision, Recall, and Agreement Against SMRITI-Reference}
\label{sec:results-annotation}
\input{sections/reference_results.tex}
