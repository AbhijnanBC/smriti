...
integration test
(\url{test_bidirectional_entailment_both_ways_discovers_equivalent})
that asserts on full pipeline output rather than
...
(\url{test_equivalent_support_does_not_double_count_via_mirrored_edge})
asserting an EQUIVALENT pair's support count, which
