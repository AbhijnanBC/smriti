...
one of ten types (\texttt{DECLARATIVE\_ASSERTION},
\texttt{PROCEDURAL\_INSTRUCTION}, \texttt{QUESTION}, \texttt{HEADING}, \texttt{METADATA},
...
\texttt{NOT\_EVALUABLE} status with an explicit reason.
\texttt{NOT\_EVALUABLE} is distinct from both PASSED and FAILED: it means no real
