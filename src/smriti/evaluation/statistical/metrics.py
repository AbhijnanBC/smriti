...
METRIC_REGISTRY: Dict[str, MetricDefinition] = {
    ...
    "f1": MetricDefinition(
        ...
        units="ratio",
        range_min=0.0, range_max=1.0,
        interpretation="Higher is better. Balances precision and recall trade-off.",
        direction="higher_is_better",
    ...
    "partition_purity": MetricDefinition(
        metric_name="partition_purity",
        ...
        units="ratio",
        range_min=0.0, range_max=1.0,
        interpretation="Higher is better. Structural proxy for partition correctness.",
        direction="higher_is_better",
        dependencies=(),
    ),
    "recall_at_k": MetricDefinition(
        ...
        units="ratio",
        range_min=0.0, range_max=1.0,
        interpretation="Higher is better. Structural proxy for retrieval correctness.",
        direction="higher_is_better",
        dependencies=(),
    ),
    "calibration": MetricDefinition(
        metric_name="calibration",
        definition="Fraction of reliability scores in valid range [0, 100]",
        formula="in_range_count / total_count",
        units="ratio",
        range_min=0.0, range_max=1.0,
        interpretation="1.0 = all scores properly bounded. < 1.0 = calibration error.",
        direction="higher_is_better",
        dependencies=(),
    ),
