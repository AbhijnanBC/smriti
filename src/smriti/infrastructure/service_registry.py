...
class ServiceRegistry:
    ...
    def register(
        ...
        publish(ArchitectureEventType.SERVICE_REGISTERED, source="infrastructure.service_registry",
                service_name=name, version=version)
    ...
    def discover(self, capability: str) -> List[ServiceEntry]:
        ...
        with self._lock:
            return [
                entry for entry in self._services.values()
    ...
    def retire(self, name: str) -> None:
        ...
        with self._lock:
            ...
            if entry:
                entry.retired = True
        from smriti.runtime.events import publish, ArchitectureEventType
        publish(ArchitectureEventType.SERVICE_RETIRED, source="infrastructure.service_registry",
                service_name=name)
